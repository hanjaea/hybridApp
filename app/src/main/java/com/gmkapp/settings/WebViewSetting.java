...
public class WebViewSetting {
	...
	public static Map<String, String> setHeader(Context context) {
		...
		extraHeaders.put("TOKEN", CPreferences.getPreferences(context, "tokenId"));
		...
		extraHeaders.put("AUTO_LOGIN_TOKEN", CPreferences.getPreferences(context, "AUTO_LOGIN_TOKEN"));
